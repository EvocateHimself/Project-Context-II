	...
	public class Player : MonoBehaviour
	{
		...
		void Update()
		{
			...
			else
			{
				...
				transform.Rotate( Vector3.down, 500.0f * Time.deltaTime * Device.LeftStick.X, Space.World );
				transform.Rotate( Vector3.right, 500.0f * Time.deltaTime * Device.LeftStick.Y, Space.World );
			}
		}
